<?php require('../includes/header.inc.php'); ?>
	...
	<div class="instructions">
		...
		This page is primarily for applications that are attempting to migrate from Beta 2 to Beta 3 and the new <b>QCubed Query</b> architecture.
		...
		While the functionality in <b>QCubed Query</b> is going to be the future of Qcodo, this deprecation causes a particular painpoint
		...
		<table cellpadding="4px" cellspacing="0px">
			...
			<tr>
				...
				<td style="border-width: 1px 1px 1px 1px; border-style: solid; border-color: black;">Fully Functional<br/><span style="font-size: 10px;">(will utilize <b>QCubed Query</b>)</span></td>
			</tr>
		</table>
		<br/>
		...
		even though the applicaiton is running "QCubed <?php _p(QCODO_VERSION); ?>".  The other example shows Beta 2-style <b>Object Expansion</b> in 
