 ...
 */
	class QFCKeditor extends QControl {
        ...
        public function __construct($objParentObject, $strControlId = null) {
            ...
            $this->strBasePath = __VIRTUAL_DIRECTORY__ . "/assets/js/_core/fckeditor/";
		...
		protected function GetControlHtml() {
			if($this->strTextMode == QFCKeditorTextMode::XHTML){
				require_once(__DOCROOT__.__VIRTUAL_DIRECTORY__.'/assets/js/_core/fckeditor/fckeditor.php');
