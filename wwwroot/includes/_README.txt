...
The qcodo/ subdirectory contains the codebase for the QCubed framework, itself.

	** CodeGen, QForm and QControl Customizations

	If you want to make *customizations* to parts of the QCubed framework, you can
	...
	** QCubed Core
	...
	or to add functionality in QCubed that does not exist, you are encouraged to post
	your changes to the QCubed Forums (http://www.qcu.be/forum/) so that those
	changes/fixes can hopefully be integrated into the QCubed core.
