...
<?php print("<?php\n"); ?>
	 ...
	 *
	 */
	class <?php echo $objTable->ClassName  ?>ListPanel extends QPanel {
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = __DOCROOT__ . __PANEL_DRAFTS__ . '/<?php echo $objTable->ClassName  ?>ListPanel.tpl.php';
			...
			$this->dtg<?php echo $objTable->ClassNamePlural  ?>->ItemsPerPage = 8;
