...
class QDatabaseTests extends QUnitTestCaseBase {
	...
	public function testTransactionWithCacheSaveRollBack() {
		...
		$this->assertEqual(count(QApplication::$objCacheProvider->arrLocalCache), 0, "Object is not placed in a cache because of the transaction roll back.");
	...
	public function testTransactionWithCacheSaveRollBack2() {
		...
		$this->assertEqual(count(QApplication::$objCacheProvider->arrLocalCache), 1, "Object is not dropped from a cache because of the transaction roll back.");
		foreach (QApplication::$objCacheProvider->arrLocalCache as $objPerson) {
			$this->assertEqual($objPerson->FirstName, $strPerson1_FirstName, "Object is not modified in a cache because of the transaction roll back.");
		}
	...
	public function testTransactionWithCacheSaveCommit() {
		...
		$this->assertEqual(count(QApplication::$objCacheProvider->arrLocalCache), 1, "Object is added to a cache because of the transaction commit.");
		foreach (QApplication::$objCacheProvider->arrLocalCache as $objPerson) {
			$this->assertEqual($objPerson->FirstName, "New value 1", "Object is modified in a cache because of the transaction commit.");
		}
	...
	public function testTransactionWithCacheSaveCommit2() {
		...
		$this->assertEqual(count(QApplication::$objCacheProvider->arrLocalCache), 1, "Object is not dropped from a cache because of the transaction commit.");
		foreach (QApplication::$objCacheProvider->arrLocalCache as $objPerson) {
			$this->assertEqual($objPerson->FirstName, "New value 1", "Object is modified in a cache because of the transaction commit.");
		}
	...
	public function testTransactionWithCacheDeleteCommit() {
		...
		$this->assertEqual(count(QApplication::$objCacheProvider->arrLocalCache), 0, "Object is not placed in a cache after delete because of the transaction commit.");
	...
	public function testTransactionWithCacheDeleteCommit2() {
		...
		$this->assertEqual(count(QApplication::$objCacheProvider->arrLocalCache), 0, "Object is removed from a cache after delete because of the transaction commit.");
	...
	public function testTransactionWithCacheDeleteRollBack() {
		...
		$this->assertEqual(count(QApplication::$objCacheProvider->arrLocalCache), 0, "Object is not placed in a cache after delete because of the transaction roll back.");
