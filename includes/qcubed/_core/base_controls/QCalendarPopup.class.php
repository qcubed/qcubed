<?php
	/**
	 * This file contains the QCalendarPopup class.
	 *
	 * @package Controls
	 */
	 ...
	 * @package Controls
	 *
	 * @property integer $DateTime is a Date object for the specified date
	...
	class QCalendarPopup extends QControl {
		...
		// SETTINGS
		protected $strJavaScripts = 'calendar_popup.js';
			...
			switch ($this->strCalendarType) {
				...
				case QCalendarType::DateTimeSeconds:
				  ...
				  $strSecond = "";
					...
					if (array_key_exists($strKey, $_POST)) {
						$blnChanged = true;
						$strSecond = $_POST[$strKey];
					}
					
					$dttNewDateTime->SetTime($strHour, $strMinute, $strSecond);
