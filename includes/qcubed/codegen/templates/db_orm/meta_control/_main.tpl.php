...
<?php 	if ($objColumn->Reference && !$objColumn->Reference->IsType) { ?>
	require_once(__META_CONTROLS__ . '/<?php echo $objColumn->Reference->VariableType ?>ObjectSelector.class.php');
<?php } ?>
<?php } ?>
<?php foreach ($objTable->ReverseReferenceArray as $objReverseReference) { ?>
<?php if ($objReverseReference->Unique) { ?>
	require_once(__META_CONTROLS__ . '/<?php echo $objReverseReference->VariableType ?>ObjectSelector.class.php');
<?php } ?>
<?php } ?>
