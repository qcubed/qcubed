<?php
	 ...
	 * listing a collection of Project objects.  It includes
	 ...
	 *
	 */
	class ProjectDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this Project datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Project object, or it can be any QQNode extending from QQN::Project().
		 *
		 ...
		 * sorting using two fields from the Project object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Project
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Project::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from Project, given the clauses above
			$this->DataSource = Project::QueryArray($objConditions, $objClauses);
		}

		/**
		 * Used internally by the Meta-based Add Column tools.
		 *
		 * Given a QQNode or a Text String, this will return a Project-based QQNode.
		 * It will also verify that it is a proper Project-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'project') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "project".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Project()->Id;
				case 'ProjectStatusTypeId': return QQN::Project()->ProjectStatusTypeId;
				case 'ManagerPersonId': return QQN::Project()->ManagerPersonId;
				case 'ManagerPerson': return QQN::Project()->ManagerPerson;
				case 'Name': return QQN::Project()->Name;
				case 'Description': return QQN::Project()->Description;
				case 'StartDate': return QQN::Project()->StartDate;
				case 'EndDate': return QQN::Project()->EndDate;
				case 'Budget': return QQN::Project()->Budget;
				case 'Spent': return QQN::Project()->Spent;
				default: throw new QCallerException('Simple Property not found in ProjectDataGrid content: ' . $mixContent);
