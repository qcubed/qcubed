<?php
	...
	class LoginDataGridGen extends QDataGrid {
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Login::QueryCount($objConditions);
			}
			...
			$this->DataSource = Login::QueryArray($objConditions, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'PersonId': return QQN::Login()->PersonId;
				case 'Person': return QQN::Login()->Person;
				case 'Username': return QQN::Login()->Username;
				case 'Password': return QQN::Login()->Password;
				case 'IsEnabled': return QQN::Login()->IsEnabled;
