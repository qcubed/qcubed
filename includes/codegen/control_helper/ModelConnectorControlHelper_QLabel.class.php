...
class ModelConnectorControlHelper_QLabel extends ModelConnectorControlHelper_QControl {
	/** @var  ModelConnectorControlHelper_QLabel */
	...
	public static function Instance() {
		if (!self::$instance) {
			self::$instance = new ModelConnectorControlHelper_QLabel();
		}
