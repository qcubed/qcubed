...
<?php $_INDEX++; } ?>
			return <?= $objTable->ClassName ?>MetaControl::Create($objParentObject, <?php foreach ($objTable->PrimaryKeyColumnArray as $objColumn) { ?>$<?= $objColumn->VariableName ?>, <?php } ?>$intCreateType);
		}
