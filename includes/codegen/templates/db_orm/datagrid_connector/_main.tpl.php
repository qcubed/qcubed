...
<?php print("<?php\n"); ?>
	/**
	 * This is the DataGrid connector class for the List functionality
	...
	class <?= $objTable->ClassName ?>DataGridGen extends QDataGrid {
		...
		<?php include("connector_add_column.tpl.php"); ?>


		<?php include("connector_add_type_column.tpl.php"); ?>


		<?php include("connector_add_edit_column.tpl.php"); ?>


		<?php include("connector_data_binder.tpl.php"); ?>
