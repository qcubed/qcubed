/**
		 ...
		 *
		 * AddConnectedColumn will automatically pre-configure the column with the name, html
		 ...
		 */
		public function AddConnectedColumn($mixContent, $objOverrideParameters = null) {
