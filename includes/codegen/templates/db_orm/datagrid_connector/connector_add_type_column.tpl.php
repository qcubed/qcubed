/**
		 * Similar to AddConnectedColumn, except it creates a column for a Type-based Id.  You MUST specify
		 ...
		 */
		public function AddDbTypeColumn($mixContent, $strTypeClassName, $objOverrideParameters = null) {
			...
			$objNewColumn = new QDataGridColumn(
				...
				sprintf('<?php print("<?="); ?>(%s) ? %s::$NameArray[%s] : null;?>', $strProperty, $strTypeClassName, $strProperty),
				array(
