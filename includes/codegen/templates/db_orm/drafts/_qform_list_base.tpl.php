...
<?php print("<?php\n"); ?>
	 ...
	 * <?= $objTable->ClassName ?>DataGrid control which has connector methods to help with
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtg<?= $objTable->ClassNamePlural ?>->AddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
