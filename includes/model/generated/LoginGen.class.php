<?php
	 ...
	 * @property integer $IsEnabled the value for intIsEnabled (Not Null)
	...
	class LoginGen extends QBaseClass implements IteratorAggregate {
		 ...
		 * @var integer intIsEnabled
		 */
		protected $intIsEnabled;
		...
		public function Initialize()
		{
			...
			$this->intIsEnabled = Login::IsEnabledDefault;
		}
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Login', $intId);
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $arrPreviousItems = null, $strColumnAliasArray = array()) {
			...
			$strAliasName = array_key_exists($strAlias, $strColumnAliasArray) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objToReturn->intIsEnabled = $objDbRow->GetColumn($strAliasName, 'Integer');
		...
		*/
				...
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$objDatabase->NonQuery('
						INSERT INTO `login` (
							...
							' . $objDatabase->SqlVariable($this->intIsEnabled) . '
						)
					');
					...
					$objDatabase->NonQuery('
						...
						SET
							...
							`is_enabled` = ' . $objDatabase->SqlVariable($this->intIsEnabled) . '
						WHERE
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Login', $this->intId);
		...
		public function Reload() {
			...
			$this->intIsEnabled = $objReloaded->intIsEnabled;
		}
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'IsEnabled':
					/**
					 * Gets the value for intIsEnabled (Not Null)
					 * @return integer
					 */
					return $this->intIsEnabled;
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'IsEnabled':
					/**
					 * Sets the value for intIsEnabled (Not Null)
					 * @param integer $mixValue
					 * @return integer
					 */
					try {
						return ($this->intIsEnabled = QType::Cast($mixValue, QType::Integer));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
		...
		public static function GetSoapComplexTypeXml() {
			...
			$strToReturn .= '<element name="IsEnabled" type="xsd:int"/>';
		...
		public static function GetObjectFromSoapObject($objSoapObject) {
			...
			if (property_exists($objSoapObject, 'IsEnabled'))
				$objToReturn->intIsEnabled = $objSoapObject->IsEnabled;
		...
		public function getIterator() {
			...
			$iArray['IsEnabled'] = $this->intIsEnabled;
	...
	class QQNodeLogin extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'IsEnabled':
					return new QQNode('is_enabled', 'IsEnabled', 'Integer', $this);
