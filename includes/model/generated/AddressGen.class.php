	...
	class AddressGen extends QBaseClass implements IteratorAggregate {
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Address', $intId);
		...
		*/
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Address', $this->intId);
	...
	class QQNodeAddress extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Street':
					return new QQNode('street', 'Street', 'VarChar', $this);
				case 'City':
