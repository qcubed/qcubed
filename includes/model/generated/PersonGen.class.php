<?php
	...
	class PersonGen extends QBaseClass implements IteratorAggregate {
		 ...
		 */
		private $_objProjectAsTeamMemberArray = null;
		 ...
		 */
		private $_objProjectAsManagerArray = null;
		...
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $arrPreviousItems = null, $strColumnAliasArray = array()) {
				...
				foreach ($arrPreviousItems as $objPreviousItem) {
					if ($objPreviousItem->intId == $objDbRow->GetColumn($strAliasName, 'Integer')) {
						...
						if ((array_key_exists($strAlias, $strExpandAsArrayNodes)) &&
							...
							if(null === $objPreviousItem->_objProjectAsTeamMemberArray)
								$objPreviousItem->_objProjectAsTeamMemberArray = array();
						...
						if ((array_key_exists($strAlias, $strExpandAsArrayNodes)) &&
							(!is_null($objDbRow->GetColumn($strAliasName)))) {
							if(null === $objPreviousItem->_objProjectAsManagerArray)
								$objPreviousItem->_objProjectAsManagerArray = array();
			...
			if (isset($arrPreviousItems) && is_array($arrPreviousItems)) {
				foreach ($arrPreviousItems as $objPreviousItem) {
					...
					$prevCnt = count($objPreviousItem->_objProjectAsTeamMemberArray);
					$cnt = count($objToReturn->_objProjectAsTeamMemberArray);
					if ($prevCnt != $cnt)
						continue;
					if ($prevCnt == 0 || $cnt == 0 || !array_diff($objPreviousItem->_objProjectAsTeamMemberArray, $objToReturn->_objProjectAsTeamMemberArray)) {
						continue;
					}
					...
					$prevCnt = count($objPreviousItem->_objProjectAsManagerArray);
					$cnt = count($objToReturn->_objProjectAsManagerArray);
					if ($prevCnt != $cnt)
					    continue;
					if ($prevCnt == 0 || $cnt == 0 || !array_diff($objPreviousItem->_objProjectAsManagerArray, $objToReturn->_objProjectAsManagerArray)) {
						continue;
					}
