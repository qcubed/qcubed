	...
	class QCsvTextBox extends QTextBox {
		...
		public static function GetMetaParams() {
			return array_merge(parent::GetMetaParams(), array(
				new QMetaParam (get_called_class(), 'Delimiter', 'Default: , (comma)', QType::String),
				new QMetaParam (get_called_class(), 'Enclosure', 'Default: " (double-quote)', QType::String),
				new QMetaParam (get_called_class(), 'Escape', 'Default: \\ (backslash)', QType::String),
				new QMetaParam (get_called_class(), 'MinItemCount', 'Minimum number of items required.', QType::Integer),
				new QMetaParam (get_called_class(), 'MaxItemCount', 'Maximum number of items allowed.', QType::Integer)
			));
		}
