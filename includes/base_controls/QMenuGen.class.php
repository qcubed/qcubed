<?php	
	 ...
	 * @property boolean $Disabled 	 * Disables the menu if set to true.
	 * @property mixed $Icons 	 * Icons to use for submenus, matching an icon provided by the jQuery UI
	 * CSS Framework. 
	 * 
	 * 	* submenu (string, default: "ui-icon-carat-1-e")
	 * 

	 * @property string $Items 	 * Selector for the elements that serve as the menu items. Note: The
	 ...
	 * @property mixed $Position 	 * Identifies the position of submenus in relation to the associated
	 ...
	 * options.
	 * @property string $Role 	 * Customize the ARIA roles used for the menu and menu items. The default
		...
		**/
		public static function GetMetaParams() {
			return array_merge(parent::GetMetaParams(), array(
				new QMetaParam (get_called_class(), 'Disabled', 'Disables the menu if set to true.', QType::Boolean),
				new QMetaParam (get_called_class(), 'Items', 'Selector for the elements that serve as the menu items. Note: Theitems option should not be changed after initialization. (versionadded: 1.11.0)', QType::String),
				new QMetaParam (get_called_class(), 'Menus', 'Selector for the elements that serve as the menu container, includingsub-menus. Note: The menus option should not be changed afterinitialization. Existing submenus will not be updated.', QType::String),
				new QMetaParam (get_called_class(), 'Role', 'Customize the ARIA roles used for the menu and menu items. The defaultuses \"menuitem\" for items. Setting the role option to \"listbox\" willuse \"option\" for items. If set to null, no roles will be set, which isuseful if the menu is being controlled by another element that ismaintaining focus. Note: The role option should not be changed afterinitialization. Existing (sub)menus and menu items will not beupdated.', QType::String),
			));
		}
	}
