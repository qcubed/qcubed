<?php	
	 ...
	 * @property string $ActiveClass 	 * If specified, the class will be added to the droppable while an
	 * acceptable draggable is being dragged.
	 * @property boolean $AddClasses 	 * If set to false, will prevent the ui-droppable class from being added.
	 * This may be desired as a performance optimization when calling
	 * .droppable() init on hundreds of elements.
	 * @property boolean $Disabled 	 * Disables the droppable if set to true.
	 * @property boolean $Greedy 	 * By default, when an element is dropped on nested droppables, each
	 ...
	 * @property string $HoverClass 	 * If specified, the class will be added to the droppable while an
	 ...
	 * @property string $Tolerance 	 * Specifies which mode to use for testing whether a draggable is
		...
		**/
		public static function GetMetaParams() {
			return array_merge(parent::GetMetaParams(), array(
				new QMetaParam (get_called_class(), 'ActiveClass', 'If specified, the class will be added to the droppable while anacceptable draggable is being dragged.', QType::String),
				new QMetaParam (get_called_class(), 'AddClasses', 'If set to false, will prevent the ui-droppable class from being added.This may be desired as a performance optimization when calling.droppable() init on hundreds of elements.', QType::Boolean),
				new QMetaParam (get_called_class(), 'Disabled', 'Disables the droppable if set to true.', QType::Boolean),
				new QMetaParam (get_called_class(), 'Greedy', 'By default, when an element is dropped on nested droppables, eachdroppable will receive the element. However, by setting this option totrue, any parent droppables will not receive the element. The dropevent will still bubble normally, but the event.target can be checkedto see which droppable received the draggable element.', QType::Boolean),
				new QMetaParam (get_called_class(), 'HoverClass', 'If specified, the class will be added to the droppable while anacceptable draggable is being hovered over the droppable.', QType::String),
				new QMetaParam (get_called_class(), 'Scope', 'Used to group sets of draggable and droppable items, in addition tothe accept option. A draggable with the same scope value as adroppable will be accepted.', QType::String),
