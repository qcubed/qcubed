...
?>
	...
	<div id="formControls">
		...
		<?php $this->dtgProjectsAsRelated->RenderWithName(true); ?>

		<?php $this->dtgParentProjectsAsRelated->RenderWithName(true); ?>

		<?php $this->dtgPeopleAsTeamMember->RenderWithName(true); ?>
