...
<html>
	...
	<body>
		...
		<table border="0" cellspacing="0" width="100%">
			<tr>
				<td nowrap="nowrap" class="headingLeft"><span class="headingLeftSmall">Qcubed Development Framework <?php _p(QCODO_VERSION); ?><br /></span>Code Generator</div></td>
				<td nowrap="nowrap" class="headingRight">
					<b>PHP Version:</b> <?php _p(PHP_VERSION); ?>;&nbsp;&nbsp;<b>Zend Engine Version:</b> <?php _p(zend_version()); ?>;&nbsp;&nbsp;<b>Qcubed Version:</b> <?php _p(QCODO_VERSION); ?><br />
