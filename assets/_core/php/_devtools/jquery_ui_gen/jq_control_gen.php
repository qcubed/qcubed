...
class JqDoc {
	...
	public function __construct($strUrl, $strJqClass = null, $strJqSetupFunc = null, $strQcClass = null, $strQcBaseClass = 'QPanel')
	{
		...
		if ($strJqClass === null) {
			...
			$this->strJqClass = preg_replace('/.*\//', '', $nodes[0]->plaintext());
		} else {
...
class JqControlGen extends QCodeGenBase {
	...
	public function GenerateControl($strUrl, $strQcClass = null, $strQcBaseClass = 'QPanel') {
		$strOutDirControls = __INCLUDES__ . "/qcubed/controls";
		$strOutDirControlsBase = __INCLUDES__ . "/qcubed/_core/base_controls";
		$strJqClass = null; 
		$strJqSetupFunc = null;
		
		$objJqDoc = new JqDoc($strUrl, $strJqClass, $strJqSetupFunc, $strQcClass, $strQcBaseClass);
...
$jqControlGen->GenerateControl($baseUrl."/Draggable");
$jqControlGen->GenerateControl($baseUrl."/Droppable");
$jqControlGen->GenerateControl($baseUrl."/Resizable");
$jqControlGen->GenerateControl($baseUrl."/Selectable");
$jqControlGen->GenerateControl($baseUrl."/Sortable");

$jqControlGen->GenerateControl($baseUrl."/Accordion");
$jqControlGen->GenerateControl($baseUrl."/Autocomplete", null, 'QTextBox');
$jqControlGen->GenerateControl($baseUrl."/Button", 'QJqButton', 'QButton');
$jqControlGen->GenerateControl($baseUrl."/Datepicker");
$jqControlGen->GenerateControl($baseUrl."/Datepicker", 'QDatepickerBox', 'QTextBox');
$jqControlGen->GenerateControl($baseUrl."/Dialog");
$jqControlGen->GenerateControl($baseUrl."/Progressbar");
$jqControlGen->GenerateControl($baseUrl."/Slider");
$jqControlGen->GenerateControl($baseUrl."/Tabs");
