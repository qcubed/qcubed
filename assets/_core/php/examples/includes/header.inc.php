	...
	<head>
		...
		<script type="text/javascript">
			function ViewSource(intCategoryId, intExampleId, strFilename) {
				...
				var objWindow = window.open("<? echo __VIRTUAL_DIRECTORY__ . __EXAMPLES__ ?>/view_source.php/" + intCategoryId + "/" + intExampleId + fileNameSection, "ViewSource", "menubar=no,toolbar=no,location=no,status=no,scrollbars=yes,resizable=yes,width=1000,height=750,left=50,top=50");
				objWindow.focus();
			}
		</script>
	</head>
