			...
			<div id="footer">
				<div id="footerLeft"><a href="http://qcu.be/" title="Visit the QCubed Homepage"><img src="<?php _p(__VIRTUAL_DIRECTORY__ . __IMAGE_ASSETS__ . '/images/qcubed_logo_footer.png'); ?>" alt="QCubed - A Rapid Prototyping PHP5 Framework" /></a></div>
				<div id="footerRight">
